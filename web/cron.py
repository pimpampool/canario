...
def lanzar_lecturas():
    ...
    for dire in Address.objects.all():
        ...
        try:
            ...
            Lectura().add_new(dire,1,ahashpool_total,dire.cryptocurrency)
            # if coindesk_USD:
        ...
        try:
            ...
            Lectura().add_new(dire,2,zergpool_total,dire.cryptocurrency)
        except:
            zergpool_total = 0
        ...
        try:
            ...
            Lectura().add_new(dire,3,zpool_total,dire.cryptocurrency)
        except:
            zpool_total = 0
        ...
        try:
            ...
            Lectura().add_new(dire,4,hashrefinery_total,dire.cryptocurrency)
        except:
        ...
        for pool in Lectura().POOLS:
            if pool[0] > 0:
                ...
                lecturas.append(lec)
                total +=  lec.cash
        Lectura().add_new(dire,0,total,dire.cryptocurrency)
